...
public enum AlarmSample {
	 ...
	 */
	private AlarmSample(int intValue) {
		assert(intValue>=0);
	 ...
	 */
	public static AlarmSample getSetDefault() {
		return SET_MEDIUM;
	}
	 ...
	 */
	public static AlarmSample cleared() {
		return CLEARED;
	}
	 ...
	 */
	private AlarmSample fromInteger(int n) {
		for (AlarmSample al: AlarmSample.values()) {
			if (n==al.asInteger) {
				return al;
			}
		}
	 ...
	 */
	public AlarmSample increasePriority() {
		if (asInteger==0) {
	 ...
	 * @return the alarm with increased priority
	 */
	public AlarmSample lowerPriority() {
		if (asInteger==0) {
