...
class DasuImpl (
  ...
  outputPublisherInitialized match {
    ...
    case Success(s) => DasuImpl.logger.info("DASU [{}] publisher successfully initialized",id)
  }
  ...
  inputSubscriberInitialized match {
    ...
    case Success(s) => DasuImpl.logger.info("DASU [{}] subscriber successfully initialized",id)
  }
