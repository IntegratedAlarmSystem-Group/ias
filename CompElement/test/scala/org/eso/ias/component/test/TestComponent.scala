...
class TestComponent extends FlatSpec {
  ...
  val supervId = new Identifier(Some[String]("SupervisorId"), Some(IdentifierType.SUPERVISOR),None)
  
  // The ID of the DAS where the components runs
  val dasId = new Identifier(Some[String]("DAS-ID"),Some(IdentifierType.DASU),Some(supervId))
  
  // The ID of the component to test
  val compId = new Identifier(Some[String]("ComponentId"), Some(IdentifierType.ASCE),Option[Identifier](dasId))
  
  // The ID of the output generated by the component
  val outId = new Identifier(Some[String]("OutputId"), Some(IdentifierType.IASIO),Some(compId))
  ...
  val mpI1Identifier = new Identifier(Some[String](requiredInputIDs(0)), Some(IdentifierType.IASIO),Option[Identifier](compId))
  ...
  val mpI2Identifier = new Identifier(Some[String](requiredInputIDs(1)), Some(IdentifierType.IASIO),Option[Identifier](compId))
