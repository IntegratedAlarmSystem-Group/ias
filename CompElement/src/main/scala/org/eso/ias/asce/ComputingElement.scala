...
/**
  ...
  * to implement what we name synthetic parameters.
  *
  * The inputs of the ASCE comes either from the BSDB (i.e. monitored systems or
  * other DASUs) or from other ASCEs running in the same DASU.
...
abstract class ComputingElement[T](
   ...
   * 
   * @param immutableMapOfInputs the immutable map of inputs to run the TF
