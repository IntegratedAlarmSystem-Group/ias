...
class JsonMsg(object):
    ...
    def __init__(self, mpointId, value, valueType, timestamp=datetime.utcnow(), operationalMode=None):
        ...
        @param valueType: the type (string) of the value
    ...
    def parse(jsonStr):
        ...
        mPointType = obj[JsonMsg.valueTypeJsonParamName]
        value = obj[JsonMsg.valueJsonParamName]
        mode = obj[JsonMsg.operationaModeParamName]
